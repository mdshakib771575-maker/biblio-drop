...
export default function FilterPanel() {
    ...
    return (
        <Card className="relative overflow-hidden border backdrop-blur-2xl p-7 mt-5 shadow rounded-3xl w-11/12 mx-auto" radius="none">
            ...
            <div className="gap-6 grid grid-cols-1 md:grid-cols-4 items-end">
                ...
                {/* Location Selector */}
                <div className="flex flex-col gap-2">
                    <Label htmlFor="filter-location" className="text-xs font-bold uppercase tracking-wider text-slate-400">Author</Label>
                    <div className="relative group">
                ...
                <div className="flex gap-3 w-full">
                    <Button
                        ...
                        className="flex-grow bg-gradient-to-r from-pink-500 via-pink-500 to-purple-500 text-white font-bold h-12 shadow-lg shadow-pink-500/25 hover:shadow-pink-500/40 hover:scale-[1.02] active:scale-95 transition-all duration-200"
