    ...
    <section className="py-24 bg-[#f8f6fc]">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="text-5xl md:text-5xl font-bold text-[#1a1238]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {steps.map((step) => {
            ...
            return (
              ...
              >
                {/* Background Number */}
                <span className="absolute top-10 left-12 text-6xl font-bold text-violet-100 ">
                  {step.number}
                </span>

                <div className="relative z-10 pt-20">
                  {/* Icon */}
                  <div className="w-20 h-20 rounded-3xl bg-gradient-to-r from-pink-500 to-purple-500 flex items-center justify-center shadow-lg shadow-violet-300 mb-10">
                    <Icon className="w-9 h-9 text-white" />
                  </div>

                  {/* Title */}
                  <h3 className="text-xl font-bold text-[#1a1238] mb-6">
                    {step.title}
                  </h3>
